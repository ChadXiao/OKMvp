...
import chad.xiao.mvpkotlin.MvpFragmentV4
 ...
 */
abstract class MvpLceFragmentV4<D, V : MvpLceView<D>, P : MvpPresenter<V>> : MvpFragmentV4<V, P>(), MvpLceView<D>, MvpLceViewImplCallback<D>{
