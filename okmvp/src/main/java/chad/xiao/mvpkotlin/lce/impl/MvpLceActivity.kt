...
/**
 * Created by Chad.xiao on 2018/11/12 0012 14:48.
 */
abstract class MvpLceActivity<D, V : MvpView, P : MvpPresenter<V>> : MvpActivity<V, P>(), MvpLceView<D>, MvpLceViewImplCallback<D>{
